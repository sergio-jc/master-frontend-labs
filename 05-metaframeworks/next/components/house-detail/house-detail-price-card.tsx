  ...
  return (
    <div className="lg:w-72 shrink-0">
      <div className="sticky top-6 bg-neutral-900 border border-neutral-800 rounded-2xl p-6 flex flex-col gap-5 shadow-xl shadow-black/50">
        ...
        <button onClick={handleReserve} className="w-full bg-rose-600 hover:bg-rose-700 active:scale-95 transition-all text-white font-bold py-3 rounded-xl shadow-lg shadow-black/40">
          Reservar ahora
        </button>
      </div>
    </div>
